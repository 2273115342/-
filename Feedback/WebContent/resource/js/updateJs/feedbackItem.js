	function add() 
	{
		document.frmAction.action = "feedbackItemAction_add";
	...
	function edit() 
	{
    	 ...
    	 document.getElementById("fiId").value=fiId;
 		document.frmAction.action = "feedbackItemAction_edit";
 		document.frmAction.submit();
...
//    	var chk = document.getElementsByName("ids");
		...
		if(confirm("操作不可恢复,您确定删除吗？")){
			document.frmAction.action = "feedbackItemAction_batchDelete";
    		document.frmAction.submit();
		}
}

function delSingle(fiId) {
	if (confirm("操作不可恢复,您确定删除吗？")) {
		document.getElementById("fiId").value = fiId;
		document.frmAction.action = "feedbackItemAction_delete";
		document.frmAction.submit();
	}
}
