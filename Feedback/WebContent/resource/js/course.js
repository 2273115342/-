	function add() 
	{
		document.frmAction.action = "courseAction_add";
	...
	function edit() 
	{
    	 ...
    	 document.getElementById("id").value=id;
    	 document.frmAction.action = "courseAction_edit";
 		 document.frmAction.submit();
...
//    	var chk = document.getElementsByName("ids");
		...
		if(confirm("操作不可恢复,您确定删除吗？")){
			document.frmAction.action = "courseAction_batchDelete";
    		document.frmAction.submit();
		}
}
...
function delSingle(id) {
	if (confirm("操作不可恢复,您确定删除吗？")) {
		document.getElementById("id").value = id;
		document.frmAction.action = "courseAction_delete";
		document.frmAction.submit();
	}
}
