...
<body>
	<form name="frmAction" id="frmAction" method="post" action="courseAction_update">
		<div id="main_frame">
			<div id="main_column">
				<div>
											...
											<table width="100%" border="0px;" cellpadding="0px;"
												...
												<tr>
													...
													<td colspan="2"><input name="course.courseName"
														...
														value="${requestScope.course.courseName}" /> <span class="info1">&nbsp;*&nbsp;${message1}</span></td>
												</tr>
												<tr>
													...
													<td><select name="course.courseType" id="course.courseType">
															...
															<option value="2" <c:if test="${requestScope.course.courseType=='2'}"> selected="selected"</c:if>>上机加理论</option>
															<option value="2" <c:if test="${requestScope.course.courseType=='3'}"> selected="selected"</c:if>>纯上机</option>
													</select></td>
												</tr>
												<tr>
													<td colspan="3">
