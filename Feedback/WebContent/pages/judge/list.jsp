									...
									<div class="statistics-box-order">
										<div class="statistics-body-order">
											...
											<table width="100%" border="0" cellpadding="3"
												...
												<c:forEach var="judgeList" items="${judgeList}" varStatus="status">
													<tr class="vieworder_row">
														<td align="center"><input type='checkbox' name='ids'
															value="${judgeList.judgeId}" /></td>
														<td align="center"><c:out value="${judgeList.judge}" /></td>
														<td align="center"><c:out value="${judgeList.request}" /></td>
														<c:if test="${judgeList.courseType==1}">
