...
<script src="resource/js/feedbackItemType.js" language="javascript"
									...
									<div class="statistics-box-order">
										<div class="statistics-body-order">
											...
											<table width="100%" border="0" cellpadding="3"
												...
												<c:forEach var="feedbackItemType" items="${feedbackItemTypes}" varStatus="status">
													<tr class="vieworder_row">
														<td align="center"><input type='checkbox' name='ids'
															value="${feedbackItemType.fitId}" /></td>
														<td align="center"><c:out value="${feedbackItemType.fitId}" /></td>
														<td align="center"><c:out value="${feedbackItemType.fitName}" /></td>
														<td align="center"><input type="button"
															onclick="editSingle(${feedbackItemType.fitId})" value=" 修 改 " /> <input type="button"
															onclick="delSingle(${feedbackItemType.fitId})"
															value=" 删 除 " /></td>
													</tr>
												</c:forEach>
											</table>
